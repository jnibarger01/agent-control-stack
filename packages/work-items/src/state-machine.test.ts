...
describe("work item state machine", () => {
  ...
  it("applies runtime-required columns from migrations before store construction", () => {
    ...
    expect(tableNames(dbPath)).toEqual(
      expect.arrayContaining([
        "desktop_commander_runtimes",
        "desktop_commander_runtime_scopes",
        "desktop_commander_bootstrap_challenges",
        "desktop_commander_capability_issuances",
        "desktop_commander_capability_issuance_scopes"
      ])
    );
  });
